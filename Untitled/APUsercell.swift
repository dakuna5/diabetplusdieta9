...
public class APUsercell : UITableViewCell {
    ...
    @IBAction func userstablesmallUsercellSwipeRight(sender: Any?) {
        self.userstablesmallUsercellAnimation2();
    self.delegate?.view(self, shouldPushViewControllerWithIdentifier: "screen3", animated: true)
    }

    internal func userstablesmallUsercellAnimation2() -> Void {
